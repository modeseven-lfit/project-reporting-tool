...
class TestJenkinsAllocationContextConcurrency:
    ...
    def test_concurrent_allocations(self):
        ...
        # Start threads
        threads = [
            threading.Thread(target=allocate_jobs, args=(i,))
            for i in range(4)
        ]
    ...
    def test_concurrent_cache_access(self):
        ...
        # Concurrent reads
        threads = [
            threading.Thread(target=read_cache, args=(i,))
            for i in range(10)
        ]
    ...
    def test_concurrent_summary_access(self):
        ...
        threads = [
            threading.Thread(target=get_summary, args=(i,))
            for i in range(20)
        ]
    ...
    def test_stress_test_allocations(self):
        ...
        threads = [
            threading.Thread(target=allocate, args=(i,))
...
class TestJenkinsAllocationContextIntegration:
    ...
    def test_concurrent_workflow_with_multiple_repos(self):
        ...
        all_jobs = {
            "jobs": [{"name": f"job{i}"} for i in range(100)]
        }
        context.set_all_jobs(all_jobs)
        ...
        threads = [
            threading.Thread(target=process_repo, args=(i,))
