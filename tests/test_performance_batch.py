...
class TestRequestQueue:
    ...
    def test_priority_ordering(self):
        ...
        queue.enqueue(APIRequest(id="critical", endpoint="/test", priority=RequestPriority.CRITICAL))
...
class TestRequestBatcher:
    ...
    def test_batch_requests(self):
        ...
        requests = [
            APIRequest(id=f"req{i}", endpoint="/test")
            for i in range(12)
        ]
...
class TestBatchProcessor:
    ...
    def test_process_batch(self):
        ...
        requests = [
            APIRequest(id=f"req{i}", endpoint="/test", params={"unique": i})
            for i in range(10)
        ]
...
class TestIntegration:
    ...
    def test_end_to_end_batch_processing(self):
        ...
        requests = [
            APIRequest(id=f"req{i}", endpoint="/test", priority=RequestPriority.NORMAL, params={"unique": i})
            for i in range(10)
        ]
        
        # Add some high priority with unique params
        requests.extend([
            APIRequest(id="urgent1", endpoint="/test", priority=RequestPriority.HIGH, params={"unique": "u1"}),
            APIRequest(id="urgent2", endpoint="/test", priority=RequestPriority.HIGH, params={"unique": "u2"}),
        ])
