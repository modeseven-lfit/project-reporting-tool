...
class TestConfigurationWizard:
    ...
    def test_wizard_full_template(self, mock_print, mock_input, tmp_path):
        ...
        mock_input.side_effect = [
            ...
            'y',  # Bundle
            'y',  # GitHub
            'y', 'https://gerrit.example.com',  # Gerrit
            'y', 'https://jenkins.example.com',  # Jenkins
            'y', 'y', 'y', 'y',  # All features
            'y', '8',  # Concurrency enabled, 8 workers
            'y', '.cache', '48',  # Cache enabled, .cache dir, 48h TTL
        ]
