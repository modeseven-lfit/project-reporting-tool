...
class TestRenderMarkdownReport:
    ...
    def test_render_markdown_delegates_to_modern(self, adapter, sample_report_data, tmp_path):
        ...
        mock_modern.render_markdown_report.assert_called_once_with(
            sample_report_data, output_path
        )
        assert isinstance(result, str)

    def test_render_markdown_logs_output_path(self, adapter, sample_report_data, tmp_path, mock_logger):
...
class TestRenderHtmlReport:
    ...
    def test_render_html_modern_logs_correctly(self, adapter, sample_report_data, tmp_path, mock_logger):
    ...
    def test_render_html_legacy_mode_with_markdown(self, adapter, sample_report_data, tmp_path, mock_logger):
    ...
    def test_render_html_legacy_logs_deprecation(self, adapter, sample_report_data, tmp_path, mock_logger):
    ...
    def test_render_html_legacy_mode_creates_valid_html(self, adapter, sample_report_data, tmp_path):
    ...
    def test_render_html_empty_string_markdown_uses_legacy(self, adapter, sample_report_data, tmp_path):
...
class TestPackageZipReport:
    ...
    def test_package_zip_delegates_to_utility(self, mock_create_bundle, adapter, tmp_path):
        ...
        mock_create_bundle.assert_called_once_with(
            output_dir, project, adapter.logger
        )
...
class TestLegacyAdapterIntegration:
    ...
    def test_full_report_generation_workflow(self, sample_config, sample_report_data, tmp_path, mock_logger):
    ...
    def test_adapter_as_drop_in_replacement(self, sample_config, sample_report_data, tmp_path, mock_logger):
    ...
    def test_concurrent_rendering_operations(self, sample_config, sample_report_data, tmp_path, mock_logger):
...
class TestLegacyAdapterEdgeCases:
    ...
    def test_render_markdown_file_not_created_by_modern(self, adapter, sample_report_data, tmp_path):
