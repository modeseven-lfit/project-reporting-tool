...
class TestGetAllJobs:
    ...
    def test_get_all_jobs_success(self, jenkins_client, mock_stats):
        ...
        jobs_data = {
            "jobs": [
                create_mock_job("job1"),
                create_mock_job("job2"),
                create_mock_job("job3")
            ]
        }
...
class TestGetJobsForProject:
    ...
    def test_get_jobs_no_matches(self, jenkins_client):
        ...
        jobs_data = {
            "jobs": [
                create_mock_job("other-job1"),
                create_mock_job("other-job2")
            ]
        }
...
class TestEdgeCases:
    ...
    def test_very_large_job_list(self, jenkins_client):
        ...
        large_jobs = {
            "jobs": [create_mock_job(f"job-{i}") for i in range(1000)]
        }
...
class TestIntegrationScenarios:
    ...
    def test_complete_project_job_flow(self, jenkins_client):
        ...
        jobs_data = {
            "jobs": [
                create_mock_job("test-project-verify"),
                create_mock_job("test-project-merge")
            ]
        }
