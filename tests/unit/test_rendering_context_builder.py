    ...
    def test_authors_repos_sorted(self):
        ...
        data = {
            'repositories': [
                {
                    'name': 'zebra',
                    'authors': [{'name': 'Alice', 'email': 'alice@example.com', 'commit_count': 10}]
                },
                {
                    'name': 'alpha',
                    'authors': [{'name': 'Alice', 'email': 'alice@example.com', 'commit_count': 10}]
        ...
        data = {
            'repositories': [
                ...
                },
                {
                    'name': 'repo2',
                    'workflows': [
                        {'name': 'Deploy', 'status': 'failure', 'state': 'active', 'url': 'http://deploy'}
                    ]
                }
            ]
        }
...
class TestEdgeCases:
    ...
    def test_large_dataset(self):
        ...
        for i in range(100):
            authors = [
                {'name': f'Author{i}_{j}', 'email': f'author{i}_{j}@example.com', 'commit_count': 10}
                for j in range(10)
            ]
            repos.append({
                'name': f'repo{i}',
