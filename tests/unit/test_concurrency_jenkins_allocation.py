...
class TestConcurrentAccess:
    ...
    def test_concurrent_cache_access(self):
        ...
        threads = [
            threading.Thread(target=cache_and_retrieve, args=(i,))
            for i in range(10)
        ]
    ...
    def test_concurrent_all_jobs_access(self):
        ...
        threads = [
            threading.Thread(target=set_and_get_all_jobs, args=(i,))
            for i in range(5)
        ]
    ...
    def test_concurrent_summary_generation(self):
        ...
        threads = [
            threading.Thread(target=allocate_and_summarize, args=(i,))
            for i in range(5)
        ]
    ...
    def test_concurrent_reset(self):
        ...
        threads = [
            threading.Thread(target=allocate_and_reset, args=(i,))
            for i in range(10)
        ]
...
class TestIntegrationScenarios:
    ...
    def test_orphaned_jobs_workflow(self):
        ...
        orphaned = {
            "jobs": [{"name": f"job{i}"} for i in range(4, 10)]
        }
        context.set_orphaned_jobs(orphaned)
