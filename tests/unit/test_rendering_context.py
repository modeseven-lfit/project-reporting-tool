    ...
    return {
        ...
        "summaries": {
            ...
            "top_contributors_loc": [
                {"name": "user1", "lines": 5000}
            ],
            "top_organizations": [
                {"name": "org1", "commits": 150}
            ]
        },
...
class TestRenderContextBuild:
    ...
    def test_build_has_required_keys(self, minimal_data, minimal_config):
        ...
        required_keys = [
            "project", "summary", "repositories", "contributors",
            "organizations", "features", "workflows", "orphaned_jobs",
            "time_windows", "config", "filters"
        ]
