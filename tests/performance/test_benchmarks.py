...
class TestIntegratedBenchmarks:
    ...
    def test_benchmark_concurrent_cache_access(
        self, benchmark, temp_cache_dir: Path
    ):
...
class TestMemoryBenchmarks:
    ...
    def test_benchmark_cache_with_many_entries(
        self, benchmark, temp_cache_dir: Path
    ):
...
class TestComparisonBenchmarks:
    ...
    def test_benchmark_compare_cache_hit_vs_miss(
        self, benchmark, temp_cache_dir: Path
    ):
    ...
    def test_benchmark_compare_batch_sizes(
        self, benchmark, mock_api_responses: List[Dict]
    ):
...
class TestOptimizationBenchmarks:
    ...
    def test_benchmark_optimized_cache_lookup(
        self, benchmark, temp_cache_dir: Path
    ):
