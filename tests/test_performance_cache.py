...
class TestAnalysisResultCache:
    ...
    def test_result_with_config(self, cache_manager):
        ...
        assert analysis_cache.get_result("https://github.com/test/repo", "commits", config1) == result1
        assert analysis_cache.get_result("https://github.com/test/repo", "commits", config2) == result2
