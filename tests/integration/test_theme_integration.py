...
from src.rendering.modern_renderer import ModernReportRenderer as NewModernReportRenderer
...
class TestThemeSystemIntegration:
    ...
    def test_theme_config_valid(self, theme_dir):
        ...
        for theme_name in ["default", "dark", "minimal"]:
            ...
            assert "accessibility" in config, f"Theme {theme_name} config should have 'accessibility'"
